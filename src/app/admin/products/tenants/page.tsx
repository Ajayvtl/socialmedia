...
import { PlusIcon, EyeIcon, KeyIcon, XMarkIcon, PencilIcon, CheckCircleIcon } from '@heroicons/react/24/outline';
...
export default function TenantListPage() {
    ...
    const [modalMode, setModalMode] = useState<'edit' | 'credentials' | 'features' | null>(null);
        ...
        <div className="p-8">
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Branch (All)</h1>
                    <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
                        Manage all registered tenants and their subscription status.
                    </p>
                </div>
                <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <Link
                        href="/admin/products/tenants/create"
                ...
                selectedHotel && modalMode === 'edit' && (
                    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                        <div className="bg-white dark:bg-slate-800 rounded-xl p-8 max-w-lg w-full relative">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Edit Tenant</h3>
                            <form onSubmit={handleUpdateHotel} className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium dark:text-gray-300">Tenant Name</label>
