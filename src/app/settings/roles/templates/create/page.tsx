...
export default function CreateRoleTemplatePage() {
    ...
    const fetchPermissions = async () => {
        try {
            ...
            // payload might be array or object with modules
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            await api.post('/settings/roles/templates', formData);
        ...
        <div className="p-8 max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">Define a standard set of permissions for reuse.</p>
                </div>
            </div>
